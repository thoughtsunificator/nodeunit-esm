...
export const testRunModule = function (test) {
		test.expect(59);
		let call_order = [];
		let testmodule = {
				test1: function (test) {
...
export const testRunModuleTestSpec = function (test) {
		test.expect(22);
		let call_order = [];
		let testmodule = {
				test1: function (test) {
...
export const testRunModuleEmpty = function (test) {
...
export const testNestedTests = function (test) {
		let call_order = [];
		let m = {
				test1: function (test) {
						test.done();
